...
Version 6:
        ...
        - boolean on
*/
public class SheetMusicFileParserV6 extends SheetMusicFileParser {
    ...
    public SheetMusic readSheetMusic(BufferedPianoFileReader in) throws IOException {
        ...
        //length in ms
        sheetMusic.setSongLengthMS(in.readInt());
    ...
    public void writeSheetMusic(BufferedPianoFileWriter out, SheetMusic sheetMusic) throws IOException {
        //song length
        out.writeInt((int)sheetMusic.getSongLengthMS(), SONG_LENGTH);
