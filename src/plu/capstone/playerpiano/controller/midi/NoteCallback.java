...
/**
 * This is the callback interface for the {@link SheetMusic} class.
 */
public interface NoteCallback {
     ...
     * By default, this is 0. If the offset is negative, we will call {@link #onNotesPlayed(Note[], long)} of the timestamp minus the offset.
     *
